...
<body>
	...
	<section id="content">
		...
		<main>
			<div class="top">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li class="arrow-icon"><i class='bx bx-chevron-right'></i></li>
						<li><a href="addNotice.jsp" class="active">Update Notice</a></li>
					</ul>
				</div>
			...
			<div class="container">
            <form action="<%=request.getContextPath() %>/UpdateNoticeServlet" class="formClass" method="post">

					<label for="nName">Notice Title</label><br>
					<input type="text" id="nName" name="nName" value="<%= (request.getAttribute("notice") != null) ? ((Notice)request.getAttribute("notice")).getnName() : "" %>" required><br>

					<label for="nDescription">Notice Date</label><br>
					<input id="nDescription" name="nDescription" value ="<%= (request.getAttribute("notice") != null) ? ((Notice)request.getAttribute("notice")).getnDescription() : "" %>" required><br>

					<label for="nDate">Description</label><br>
					<input type="text" id="nDate" name="nDate" value ="<%= (request.getAttribute("notice") != null) ? ((Notice)request.getAttribute("notice")).getnDate() : "" %>" required><br>

					<label for="nBatch">Select the Batch</label><br>
					<input type="text" id="nBatch" name="nBatch" value ="<%= (request.getAttribute("notice") != null) ? ((Notice)request.getAttribute("notice")).getnBatch() : "" %>" required><br>
					
					<input type="hidden" name="NoticeID" value="<%= (request.getAttribute("notice") != null) ? ((Notice)request.getAttribute("notice")).getNoticeID() : "" %>">
