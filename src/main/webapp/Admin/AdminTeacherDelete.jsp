...
<%	
	Teacher teacherDetails = (Teacher) session.getAttribute("singleTeacher");
...
<title>Teacher Profile Delete</title>
		...
		<main>
			...
			<div class="box-info">
				...
				<div class="box">
					...
					<div class="text">
						<h3 style="font-size: 44px;">Delete Teacher Account</h3>
					</div>
				</div>
			...
			<div class="table-data">
				<div class="order">
					...
					<table>
						...
						<tbody>
							<tr>
								<td><span class="badge completed">Teacher ID : </span>
								</td>
								<td>
									<span class="name"><%=teacherDetails.getTeacherID()%></span>
								</td>
							</tr>
							<tr>
			...
			<a href="<%=request.getContextPath() %>/TeacherDeleteProfileServlet?id=<%=teacherDetails.getTeacherID()%>"><input type="button" class="deletebtn" name="delete" value="Delete Account"></a>
